...
<html lang="en">
  <head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/style_jelajah.css">
    <!-- Fontawesome CSS -->
    ...
    <div class="row">
      <div class="col-3 sidenav">
        ...
        <div class="row bg5">
          <div class="col">
            <div class="nav1-position">
              <a href="<?= base_url('/approve');?>" class="fa fa-check-circle btnapprove">
                <btn class="impact"> 
                  Approvement
                </btn>
              </a>
        ...
        <div class="row bg5">
          <div class="col">
            <div class="nav1-position">
              <a href="#" class="fa fa-home btnhome">
                <btn class="impact"> 
                  Beranda
                </btn>
              </a>
      ...
      <div class="col-9 main">
        <div class="row bg2">
          ...
          <div class="col-4 bg3">
              <div>
              <form action="<?= base_url('/search_jelajah') ?>" method="post" class="form-inline search-position">
                    ...
                    ?>
                        <div class="card mb-4 pb-2 mt-2 pt-2" style="width: 80%; margin-left: 5%">
                            <div class="card-body">
                                ...
                                <a href="<?= base_url('/delete_a/'.$postingans['id_posting']) ?>" class="btn btn-danger">Hapus</a>
                            </div>
